...
public class JIFClientGUI extends javax.swing.JInternalFrame {
    ...
    private void jButtonActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonActualizarActionPerformed
        ...
        if(jTextField_nombres.getText().equals("")||
            ...
            w.setClient_codigocliente("0");
            w.setClient_tipo("codigo");
            w.setPerson_id(jTextField_id.getText());

            ip.ActualizarClient(w);
    ...
    public void AddOneReporteData(){
        Object[] fila = new Object[6];
                    ...
                    fila[4] = jTextField_codigo_cliente.getText();
                    fila[5] = jTextField_id.getText();
    ...
    public void updateOneReporteData(int rowSelected){
        Object[] fila = new Object[6];
                    jTableCliente.setValueAt(jTextField_nombres.getText(), rowSelected, 0);
                    ...
                    jTableCliente.setValueAt(jTextField_codigo_cliente.getText(), rowSelected, 4);
                    jTableCliente.setValueAt(jTextField_id.getText(), rowSelected, 5);
